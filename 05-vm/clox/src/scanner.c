...
Token scanToken(Scanner *scanner) {
    ...
    switch (c) {
        ...
        case '[': return makeToken(scanner, TOKEN_LEFT_BRACKET);  /* Stage 12b-i: array literal */
        case ']': return makeToken(scanner, TOKEN_RIGHT_BRACKET); /* Stage 12b-i: array literal */
